...
// ✅ Update including hidden status
$stmt = $conn->prepare("UPDATE menu_items SET name=?, category=?, price=?, description=?, hidden=? WHERE id=?");
$stmt->bind_param("ssdsii", $name, $category, $price, $description, $hidden, $id);
